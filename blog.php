...
<body>
  ...
  <ul class="pro-features">
    ...
    <li class="big-title">
      Founder of
      <a href="https://www.facebook.com/uinilab" target="_blank">UiniLab</a>
    </li>
    <li class="big-title">This Website Design and Develop by UiniLab</li>
    <li class="big-title">
      Need Any Website, Mobile App, Ui/Ux design and Marketing Contact With
      Us.
    </li>
    <ol type="1">
      <li>E-commerce Website</li>
      <li>Travel Agency Website</li>
      <li>Medical Website</li>
      <li>Portfolio Website</li>
      <li>NEWS Website</li>
      <li>Blog Website</li>
    </ol>
    <div class="button">
      <a href="https://www.facebook.com/uinilab" target="_blank" class="btn">Facebook Page [UiniLab]</a>
      <a href="https://wa.me/+8801714532308" target="_blank" class="btn">WhatsApp</a>
    </div>
  </ul>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 col-12">
            ...
            <ul class="top-link">
              <li>
                <a href="https://www.facebook.com/quickflylimited"><i class="icofont-facebook"></i></a>
              </li>
              <li>
                <a href="https://wa.me/+8801620862832"><i class="icofont-whatsapp"></i></a>
              </li>
              <li>
                <a href="signin.html"><i class="icofont-icon-user"></i></a>
              </li>
            </ul>
            <!-- End Contact -->
          </div>
        ...
        <div class="inner">
          <div class="row align-items-center">
            <div class="col-xl-3 col-lg-2 col-md-3 col-12">
              <!-- Start Logo -->
              <div class="logo">
                <a href="index.html"><img src="img/logov.png" alt="#" /></a>
              </div>
              <!-- End Logo -->
              <!-- Mobile Nav -->
                ...
                <nav class="navigation">
                  <ul class="nav justify-content-end align-item-center menu">
                    ...
                    <li>
                      ...
                      <ul class="dropdown">
                        <li><a href="index.html">Flight Tickets</a></li>
                        <li><a href="index.html">Visa & Passport</a></li>
                        <li><a href="index.html">Hajj & Umrah</a></li>
                        <li><a href="index.html">Man Power</a></li>
                        <li><a href="index.html">Tour Packages</a></li>
                      </ul>
                    </li>
                    <li class="sparkle">
                      <a href="portfolio-details.html" class="sparkle-blink bg-danger">Hajj & Umrah</a>
                    </li>
                    <li>
                      <a href="#">Pages</a>
                    </li>
          ...
          <div class="row">
            <div class="col-12">
              <div class="single-main">
                ...
                <!-- News Title -->
                <h1 class="news-title">
                  <a href="news-single.html">Masjid Al-Haram</a>
                </h1>
                <!-- Meta -->
                <div class="meta">
                  <div class="meta-left">
                ...
                <div class="comments-body">
                  ...
                  <div class="single-comments">
                    <div class="main">
                      ...
                      <div class="body">
                        <h4>Khairul Basyar Ash-Shafi</h4>
                        <div class="comment-meta">
                          <span class="meta"><i class="fa fa-calendar"></i>March 05,
                            2019</span><span class="meta"><i class="fa fa-clock-o"></i>03:38 AM</span>
                        </div>
          ...
          <div class="main-sidebar">
            ...
            <div class="single-widget category">
              ...
              <ul class="categor-list">
                <li><a href="#">Travel Story</a></li>
                <li><a href="#">Historical Place</a></li>
                <li><a href="#">Upcoming Events</a></li>
                <li><a href="#">Flight Packages</a></li>
              </ul>
            </div>
            <!--/ End Single Widget -->
            <!-- Single Widget -->
            <div class="single-widget recent-post">
              ...
              <div class="single-post">
                ...
                <div class="content">
                  <h5><a href="#">Göreme National Park.</a></h5>
                  <ul class="comment">
                    <li>
              ...
              <div class="single-post">
                ...
                <div class="content">
                  <h5>
                    <a href="#">The great white north.</a>
                  </h5>
                  <ul class="comment">
                    <li>
          ...
          <div class="col-lg-3 col-md-6 col-12">
            <div class="single-footer">
              ...
              <ul class="social">
                ...
                <li>
                  <a href="signin.html"><i class="icofont-google-plus"></i></a>
                </li>
              </ul>
              <!-- End Social -->
            </div>
          ...
          <div class="col-lg-12 col-md-12 col-12">
            <div class="copyright-content">
              <p>
                ...
                <a href="https://www.uinilab.com" target="_blank">UiniLab</a>
              </p>
            </div>
          </div>
        </div>
